    ...
    <div class="container">
                            ...
                            <?php foreach ($_SESSION['cart'] as $item) : ?>
                                <td data-th="Product">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 text-left mt-sm-2">
                                            ...
                                            <p class="font-weight-light"><?= $item['nama_produk'] ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td data-th="Price"><?= "Rp. " . number_format($item['harga'] * $item['qty']); ?></td>
                                <td data-th="Quantity">
                                ...
                                <td class="actions" data-th="">
                                    <div class="text-right">
                                        ...
                                        <a href="?pg=action-cart&delete-cart=<?= $item['id_produk'] ?>" <button class="btn btn-white border-secondary bg-white btn-md mb-2">
        ...
        <div class="row mt-4 d-flex align-items-center">
            <div class="col-sm-6 order-md-2 text-right">
                <a href="checkout.php" class="btn btn-primary mb-4 btn-lg pl-5 pr-5">Checkout</a>
            </div>
